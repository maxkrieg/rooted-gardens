...
/**
 * The crew mobile shell — moved out of app/crew/layout.tsx (task 9.2) so
 * that layout can stay a server component and export PWA metadata
 * (`manifest`, `appleWebApp`), which a `'use client'` layout can't do.
 */
